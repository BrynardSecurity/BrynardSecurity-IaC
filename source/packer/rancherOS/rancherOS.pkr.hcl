# ----------------------------------------------------------------------------
# Name:         rancherOS.pkr.hcl
# Description:  Build definition for RancherOS
...
source "vsphere-iso" "rancher" {
    ...
    vm_name                     = "rancherOS-${ var.build_branch }-${ local.build_version }"
